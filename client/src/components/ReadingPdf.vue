  ...
  <div class="page-container">
    ...
    <ul class="footers">
      ...
      <input type = "number" class="val" :value = value />
        ...
        <a class = "down-p" href="http://localhost:4000/6fbe33a0-2fe1-403c-b0ad-0eac7bde681d.pdf">Скачать </a>
...
export default {
  ...
  data() {
    return {
      ...
      idx: -1,
      loadedRatio: 0,
      src: 'http://localhost:4000/6fbe33a0-2fe1-403c-b0ad-0eac7bde681d.pdf',
      value:1
    }
  },
  created() {
